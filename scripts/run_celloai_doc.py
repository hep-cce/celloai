...
from prompt_template import doxygen_function_prompt, doxygen_class_prompt
...
def main(device_type, show_sources, use_history, model_type, save_qa, temperature, llamacpp_server):
    ...
    # Code documentation
    dir_home = r'/home/atif/sphenix-celloai/coresoftware/'
    ##SOURCE_DOCUMENTS_athena/athena/MuonSpectrometer//'
    ...
    for file_path in list_all_files:
        ...
        rewrite_file_with_comments(functions, file_path, doxygen_function_prompt, qa, temperature, llamacpp_server)
